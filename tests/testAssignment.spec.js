...
test('Network assignment for 6 events', async({page}) =>
{
...
test('Network assignment for 4 events', async({page})=>
{

    // await page.goto("https://eventhub.rahulshettyacademy.com")
    // await page.getByLabel('Email').fill("bhaskara4all@gmail.com");
    // await page.getByLabel('Password').fill("Bhaskar@12345");
    // await page.getByRole('button',{name: 'Sign In'}).click();
    // await page.waitForLoadState("networkidle");
